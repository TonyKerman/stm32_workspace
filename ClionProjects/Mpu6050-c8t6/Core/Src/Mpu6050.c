...
int Mpup6050_update(Mpu6050 *me)
{
    ...
    me->pitch  = asin(-2 * me->q1 * me->q3 + 2 * me->q0* me->q2)* 57.3; // pitch ,转换为度数
    me->roll = atan2(2 * me->q2 * me->q3 + 2 * me->q0 * me->q1, -2 * me->q1 * me->q1 - 2 * me->q2* me->q2 + 1)* 57.3; // rollv
    me->yaw = atan2(2*(me->q1*me->q2 + me->q0*me->q3),me->q0*me->q0+me->q1*me->q1-me->q2*me->q2-me->q3*me->q3) * 57.3;                //此处没有价值，注掉
