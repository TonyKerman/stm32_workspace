...
xMBMasterPortEventPost( eMBMasterEventType eEvent )
{
    ...
    xEventGroupSetBitsFromISR(xMasterOsEvent,eEvent,NULL);
    return TRUE;
}
...
BOOL xMBMasterRunResTake( LONG lTimeOut )
{
    ...
    return xSemaphoreTake(xMasterRunRes,lTimeOut/portTICK_PERIOD_MS)==pdTRUE?TRUE:FALSE;
}
...
void vMBMasterErrorCBRespondTimeout(UCHAR ucDestAddress, const UCHAR* pucPDUData,
    ...
    xEventGroupSetBitsFromISR(xMasterOsEvent,EV_MASTER_ERROR_RESPOND_TIMEOUT,NULL);
...
eMBMasterReqErrCode eMBMasterWaitRequestFinish( void ) {
    ...
    //         RT_EVENT_FLAG_OR | RT_EVENT_FLAG_CLEAR, RT_WAITING_FOREVER,
    //         &recvedEvent);
    xEventGroupWaitBits(xMasterOsEvent,
            EV_MASTER_PROCESS_SUCESS | EV_MASTER_ERROR_RESPOND_TIMEOUT
                    | EV_MASTER_ERROR_RECEIVE_DATA
                    | EV_MASTER_ERROR_EXECUTE_FUNCTION,
            pdTRUE, pdFALSE, portMAX_DELAY);
